...
for x in wmydoc:
    if count < 1 :
        ...
        messageId = '16a03726-3dae-42fe-b9fc-94a2800d7289'
        ...
        for t in transection:
            ...
            for sub_t in sub_transection:
                topic = sub_t['topic']
                mfilter = {"messageId": messageId, "transection": {"$elemMatch": {"topic": topic, "ackcode": "wating ack"}}}
                newvalues = {"$set": {"transection.$.ackcode": "469", "transection.$.ackdetail": "get URI pic data len too long","send_to_WFM": False, "send_to_WFM_timestamp": "", "transection_last_update": "","worker_sync_retries": 0}}
